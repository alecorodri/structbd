...
public class RepeatDistrict extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RepeatDistrict dialog = new RepeatDistrict();
	 ...
	 * @throws SQLException 
	 */
	public RepeatDistrict() throws SQLException {
		setModal(true);
		setAlwaysOnTop(true);
		setIconImage(Toolkit.getDefaultToolkit().getImage(RepeatDistrict.class.getResource("/resources/icons8_Map_Pinpoint_16.png")));
		setTitle("Circunscripciones  que Repiten");
		setResizable(false);
		...
		LoadTable.Load_RepeatDistrict(date, table);
